...
Alongside each event go three things and nothing else: a **random install ID** (see below), your **app version**, and your **operating system** (`darwin`, `win32`, `linux`).
...
- ❌ Location — IP-based geolocation is disabled on every request we make
